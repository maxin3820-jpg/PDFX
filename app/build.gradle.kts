...
android {
    ...
    kotlinOptions {
        ...
        freeCompilerArgs += listOf(
            ...
            // Performance: enable strong skipping mode for Compose
            "-P",
    ...
    composeOptions {
        ...
        // Performance: enable Compose compiler metrics (optional, for profiling)
        // kotlinCompilerExtensionVersion = "1.5.13"
    }
...
dependencies {
    ...
    // Coil for image loading / thumbnail caching
